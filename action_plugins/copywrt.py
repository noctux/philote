...
class ActionModule(ActionBase):
    ...
    def _execute_remote_stat(self, path, all_vars, follow, tmp=None, checksum=True):
        ...
        mystat = self._execute_module(module_name='statwrt', module_args=module_args, task_vars=all_vars,
                                      wrap_async=False)
    ...
    def _copy_file(self, source_full, source_rel, content, content_tempfile, dest, task_vars):
        ...
        if local_checksum != dest_status['checksum']:
            ...
            module_return = self._execute_module(module_name='copywrt', module_args=new_module_args, task_vars=task_vars)
            ...
            module_return = self._execute_module(module_name='filewrt', module_args=new_module_args, task_vars=task_vars)
